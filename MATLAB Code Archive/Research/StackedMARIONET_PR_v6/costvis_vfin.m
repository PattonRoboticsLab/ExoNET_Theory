...
plot(phi,torque,phi,desired_torque)

%% Plot Figures
figure(1)
surf(ang,rad,cost);colorbar;set(gca,'FontSize',12);
grid off
xlabel('\phi (Rad)','FontName','Times','FontSize',20,'FontAngle','italic');
%set(get(gca,'xlabel'),'rotation',25,'VerticalAlignment','bottom');
ylabel('Radius (m)','FontName','Times','FontSize',20,'FontAngle','italic');
...
figure(2)
plot(phi,torque,'b', phi, torque_desired(1,:),'r')
 xlabel('\phi')
 ylabel('Torque')
