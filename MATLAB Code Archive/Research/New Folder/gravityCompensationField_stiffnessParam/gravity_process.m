function [bestParam_sh, bestParam_el] = gravity_process(n_angles, L_UpperArm, L_ForeArm, Mass_TotalBody)

    phi1 = linspace(-pi/2, pi/2, n_angles);
    phi2 = linspace(0, 2*pi/3, n_angles);
    ...
    %gravity_field(Lengths, Weights, phi1, phi2);

  [bestParam_sh, bestParam_el] = optimizedTorque_gravityField_overallNew(Lengths, Weights, phi1, phi2);
   % [bestParam_sh, bestParam_el] = optimizedTorque_gravityField(Lengths, Weights, phi1, phi2);
