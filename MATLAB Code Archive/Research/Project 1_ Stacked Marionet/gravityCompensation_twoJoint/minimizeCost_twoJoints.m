function  [optimal_param, optimalTorque_sh, optimalTorque_el, averageErr_el, averageErr_sh, averagePerc_el, averagePerc_sh, Rsquared_el, Rsquared_sh]...
    = minimizeCost_twoJoints(p, options, mean_err_old)
    %04/16/2018
    ...
    [torque_sh, torque_el] = stacks_twoJoints(p_new, phi_1, phi_2);
    ...
    optimal_param = p_new;
    [optimalTorque_sh, optimalTorque_el] = stacks_twoJoints(optimal_param, phi_1, phi_2);
    for i = 1:n_sh
