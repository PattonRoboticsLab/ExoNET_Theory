function [bestParam, averageErr_el, averageErr_sh, averagePerc_el, averagePerc_sh, Rsquared_el, Rsquared_sh] =...
    optimizedTorque_twoJoints(Lengths, Weights, shoulder_angle, elbow_angle)
    
    global phi_1 phi_2 desiredTorque_el desiredTorque_sh...
        n_stackedMarionet momentArm_sh momentArm_el spring_length L_ForeArm L_UpperArm n_sh n_el
    ...
    [startingTorque_sh, startingTorque_el] = stacks_twoJoints(init_param, phi_1, phi_2); %torque with random guess (matrix!)
    ...
    [bestParam, optimalTorque_sh, optimalTorque_el, averageErr_el, averageErr_sh, averagePerc_el, averagePerc_sh, Rsquared_el, Rsquared_sh] = minimizeCost_twoJoints(init_param, options, meanErr_tot);
%     figure(2)
%     for i = 1:n_sh
