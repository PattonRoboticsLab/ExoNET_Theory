function  [bestParam, averageErr_el, averageErr_sh, averagePerc_el, averagePerc_sh, Rsquared_el, Rsquared_sh] = gravityProcess_twoJoints(n_angles, L_UpperArm, L_ForeArm, Mass_TotalBody)
    ...
    [bestParam, averageErr_el, averageErr_sh, averagePerc_el, averagePerc_sh, Rsquared_el, Rsquared_sh] = optimizedTorque_twoJoints(Lengths, Weights, phi1, phi2);
