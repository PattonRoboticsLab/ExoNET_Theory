function [opt_param, err_mean, err_mean_perc] = minimization_process(n_stackedMarionet, L_upperArm, L_foreArm, choosingJoint, animations)
    ...
    options.TolFun = 1e-6;
    options.TolX = 1e-6;
    [opt_param] = minimizeCost_updateFigures(init_param, options, choosingJoint, animations); 
