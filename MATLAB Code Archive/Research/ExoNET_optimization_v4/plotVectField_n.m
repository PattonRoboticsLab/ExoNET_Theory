% plotVectField: plot the vector field resulting from a 2-joint MARIONET

function plotVectField_n(PHIs, Bod, Pos, tau, Colr)
scaleF = .002; %graphical scale factor for gforce vectors
scaleTau = .02; %graphical scale factor torque pseudo-vectors
...
%% plot in torque field in phi domain (this is cheating -- not a true vector)
