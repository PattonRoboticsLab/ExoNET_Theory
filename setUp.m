...
RLoHi=[.05 .20];thetaLoHi=2*pi*[0 1];  L0LoHi=[.21 .70];               % ranges
...
%% Tension for Yaseen's Quarter Inch Maroon
...
tension = @(L0,L) (2*(370.9*(L/L0).^5-2963*(L/L0).^4+9398*(L/L0).^3-14790*(L/L0).^2+11590*(L/L0)-3600)).*((L/L0)>1);
%% plot: 
