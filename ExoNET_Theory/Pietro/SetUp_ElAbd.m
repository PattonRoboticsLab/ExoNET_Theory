function [Pos, Bod, Exo] = SetUp_ElAbd()
...
phi1 = pi/180*linspace( -70+10^-6, 10+10^-6,  Bod.nAngles );   % Phi1 shoulder elevation
phi2 = pi/180*linspace(   0+10^-6,  0+10^-6, Bod.nAngles2 );  % Phi2 elbow flexion
...
Exo.theta = pi/180*linspace( 0, 0, Bod.n_angles_3D ); % Limited swivel angle 
