...
%% ~~ BEGIN PROGRAM: ~~
fprintf('\nSetUp parameters... \n')
global Exo Pos Bod PHIs TAUsDesired TauExo ProjectName
close all
...
Exo.stretch_ratio_limit = 3;          % can be changed depending on the spring
...
Bod.nAngles = 4;     % # phi1 elevation upperarm
Bod.nAngles2 = 2;    % # phi2 flexion elbow
Bod.nAngles_z = 3;   % # elevation planes
Bod.n_angles_3D = 2; % # humeral rotation

phi1 = pi/180*linspace( -60+10^-6, 10+10^-6,  Bod.nAngles );   % Phi1 shoulder elevation
phi2 = pi/180*linspace(   10+10^-6,  70+10^-6, Bod.nAngles2 );  % Phi2 elbow flexion
