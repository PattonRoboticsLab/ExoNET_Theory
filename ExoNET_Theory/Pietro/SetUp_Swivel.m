function [Pos, Bod, Exo] = SetUp_Swivel()
...
Bod.nAngles = 1;     % # phi1 elevation upperarm
Bod.nAngles2 = 1;    % # phi2 flexion elbow
Bod.nAngles_z = 1;   % # elevation planes
Bod.n_angles_3D = 10; % # humeral rotation

phi1 = pi/180*linspace( -40+10^-6, -40+10^-6,  Bod.nAngles );   % Phi1 shoulder elevation
phi2 = pi/180*linspace(   45+10^-6,  45+10^-6, Bod.nAngles2 );  % Phi2 elbow flexion
phi3 = pi/180*linspace(   45+10^-6, 45+10^-6,  Bod.nAngles_z ); % Phi3 plane of elevation
