function legendObjects = PlotPin_flex(Exo, Actual_Pin, shoulder_pin, shoulder_el,shoulder_sw, elbow_sw, elbow_el, bestP_3D, center_back, wrist)
    ...
    plot3( [ elbow_sw(1),  Actual_Pin.swivel(i,1) ], ...
           ...
           [ elbow_sw(3),  Actual_Pin.swivel(i,3) ], ...
           'k', 'linewidth', 1 ); 
